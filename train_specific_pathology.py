...
if args.checkpoint is not None:
    trainer = pl.Trainer(devices=4, accelerator="gpu", max_epochs=num_epochs, callbacks=[checkpoint_callback], resume_from_checkpoint=args.checkpoint)
else:
    trainer = pl.Trainer(devices=4, accelerator="gpu", max_epochs=num_epochs, callbacks=[checkpoint_callback])
