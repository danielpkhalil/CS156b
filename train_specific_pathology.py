...
if args.checkpoint is not None:
    trainer = pl.Trainer(accelerator="gpu", devices=[0,1], strategy=strategy, max_epochs=num_epochs, callbacks=[checkpoint_callback], resume_from_checkpoint=args.checkpoint)
else:
    trainer = pl.Trainer(accelerator="gpu", devices=[0,1], strategy=strategy, max_epochs=num_epochs, callbacks=[checkpoint_callback])
